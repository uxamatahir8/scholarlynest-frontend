export const STATUS_META = {
  ...
  awaiting_initial_screening: ['Awaiting Initial Screening', 'blue'],
  transfer_requested: ['Transfer Requested', 'amber'],
  desk_rejected: ['Desk Rejected', 'red'],
  screening_completed: ['Screening Completed', 'blue'],
  awaiting_sub_editor_assignment: ['Awaiting Sub-editor Assignment', 'violet'],
  awaiting_reviewer_invitation: ['Awaiting Reviewer Invitation', 'cyan'],
  reviewer_invitations_pending: ['Reviewer Invitations Pending', 'cyan'],
  reviews_partially_completed: ['Reviews Partially Completed', 'indigo'],
  reviews_completed: ['Reviews Completed', 'indigo'],
  awaiting_sub_editor_recommendation: ['Awaiting Sub-editor Recommendation', 'violet'],
  awaiting_editorial_decision: ['Awaiting Editorial Decision', 'amber'],
  minor_revision_requested: ['Minor Revision Requested', 'amber'],
  major_revision_requested: ['Major Revision Requested', 'orange'],
  awaiting_author_revision: ['Awaiting Author Revision', 'amber'],
  revision_submitted: ['Revision Submitted', 'sky'],
  awaiting_copy_editor_assignment: ['Awaiting Copy Editor Assignment', 'teal'],
  copyediting_in_progress: ['Copyediting In Progress', 'teal'],
  awaiting_author_proofreading: ['Awaiting Author Proofreading', 'teal'],
  proof_corrections_in_progress: ['Proof Corrections In Progress', 'orange'],
  proof_approved: ['Proof Approved', 'emerald'],
  awaiting_issue_assignment: ['Awaiting Issue Assignment', 'purple'],
  assigned_to_issue: ['Assigned to Issue', 'purple'],
  scheduled_for_publication: ['Scheduled for Publication', 'purple'],
  unpublished: ['Unpublished', 'zinc'],
};
