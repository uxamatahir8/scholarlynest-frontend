...
function DateTimeField({ label, value, onChange, minDate }) { return <label className="block text-sm font-bold">{label}<FlatpickrInput mode="datetime" value={value} onChange={onChange} minDate={minDate} className="mt-2" /></label>; }
